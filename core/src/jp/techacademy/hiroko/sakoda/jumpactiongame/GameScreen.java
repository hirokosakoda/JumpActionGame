package jp.techacademy.hiroko.sakoda.jumpactiongame;
...
public class GameScreen extends ScreenAdapter {
    ...
    OrthographicCamera mGuiCamera;//ビューポート
    ...
    List<Star> mStars;//生成して配置した★を保持するリスト
    List<Enemy> mEnemys;
    Ufo mUfo;//生成して配置したUFO（ゴール）を保持する
    Player mPlayer;//生成して配置したUFO（ゴール）を保持する
    ...
    public GameScreen(JumpActionGame game) {
        ...
        sound = Gdx.audio.newSound(Gdx.files.internal("enemySound.mp3"));
    ...
    //物理的な画面のサイズが変更されたときに呼び出される
    //create直後やバックグランドから復帰したとき
    @Override
    ...
    private void createStage() {
        ...
        Texture enemyTexture = new Texture("enemy3.png");
    ...
    //タッチされていたら、その座標が画面の左側なのか右側なのかを判断
